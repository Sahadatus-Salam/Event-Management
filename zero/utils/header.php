        ...
        <div class="container">
            <div class="navbar-header"><!--website name/title-->
                ...
                echo '<a href = "index.php" class = "navbar-brand">
                    Zero Gravity Event Management Systems
                </a> ';
                ?>
            </div>
    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1>Zero Gravity Event Management System</h1><!--jumbotron heading-->
                <p><!--jumbotron content-->
                Whether you're looking to book a cocktail party, post-work gathering, celebratory function, conference, business
                meeting, wedding or private dining event, our dedicated Zero Gravity team can create a package that will meet
                your every need.
                </p>
                <p id="dateAndTime"></p>
            </div>
